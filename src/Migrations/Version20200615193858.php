 ...
 */
final class Version20200615193858 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE marketplace (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, adress VARCHAR(255) NOT NULL, working_time VARCHAR(255) NOT NULL, INDEX IDX_6634DA66A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE marketplace ADD CONSTRAINT FK_6634DA66A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
